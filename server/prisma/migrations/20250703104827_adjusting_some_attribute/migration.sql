...
INSERT INTO "new_Transaction" ("amount", "createdAt", "date", "description", "trans_id", "type_id", "uid", "updatedAt", "wallet_id") SELECT "amount", "createdAt", "date", "description", "trans_id", "type_id", "uid", "updatedAt", "wallet_id" FROM "Transaction";
